...
```mermaid
flowchart LR
    Login["interfaz.java · Login"] --> Registro["Registro.java"]
    Login --> Menu["Decision.java · Menú principal"]
    Menu --> Prestamos["prestamos.java"]
    Menu --> Compras["Comprarlibros.java"]
    Prestamos --> Comprobante["facturas.java · Recibo"]
    Compras --> Comprobante
    Comprobante --> Menu
    Menu --> Login
```
